...
**Status.** Build in progress. Ch 1, Ch 2, and Ch 4 complete. Ch 3 drafted with Medicare rates locked, commercial placeholders inline, commit held pending commercial figures. Ch 5 partial swap: POS 22 OPPS rate for APC 5693 sourced to CY2026 ($216.49); J9271 pembrolizumab April 2026 ASP+6% payment limit sourced ($61.251 per mg, $12,250.20 per 200 mg dose); CPT 96365 MPFS non-facility rate and 340B pembrolizumab acquisition price still pending.
...
7. For CPT 96365 (intravenous infusion, for therapy, prophylaxis, or diagnosis; initial, up to 1 hour) under CY2026 Medicare rates, the service-level facility fee is $216.49 when billed at POS 22 under OPPS Ambulatory Payment Classification 5693 (Level 3 Drug Administration) and approximately $[CPT 96365 MPFS NON-FACILITY RATE — NEEDS SOURCE] when billed at POS 11 under the MPFS. [Source: CMS CY2026 January OPPS Addendum B, APC 5693 on-campus rate; CY2026 OPPS conversion factor $91.415; CMS CY2026 MPFS PFREV26B for POS 11 rate pending. CY2026 policy note: excepted off-campus hospital outpatient departments billing the same code at POS 19 are paid at a PFS-equivalent rate of approximately $86.60 under the CY2026 drug administration site-neutral policy, affecting 61 HCPCS codes in APCs 5691 through 5694 at an estimated $290 million CY2026 impact; the POS 22 on-campus path remains at full OPPS and is unaffected by that policy]
8. Under the April 2026 Medicare Part B Average Sales Price pricing file, a 200 mg pembrolizumab (HCPCS J9271) dose is paid at $12,250.20 under the ASP+6% methodology ($61.251 per 1 mg payment limit, multiplied by 200 mg) at both POS 11 and POS 22, while a 340B covered entity acquires the same 200 mg dose at approximately $[340B ACQUISITION PER 200 MG — NEEDS SOURCE — operator record only, 340B ceiling prices are not public], yielding a per-infusion drug spread of approximately $[DRUG SPREAD — NEEDS SOURCE — derived from claim 8 first half minus 340B acquisition] retained by the 340B hospital outpatient site. [Source: CMS Medicare Part B ASP Pricing File, April 2026 quarterly update, HCPCS J9271 payment limit per 1 mg; 42 USC 256b 340B ceiling price (manufacturer-specific, not public); Dutch Rojas operator record for 340B acquisition cost]
